...
void InterpolationGraph::enableHeightMapModel(bool enable)
{
    if (enable) {
        //! [4]
...
void InterpolationGraph::setAxisXRange(float min, float max)
{
    m_graph->axisX()->setRange(min, max);
}

void InterpolationGraph::setAxisZRange(float min, float max)
{
